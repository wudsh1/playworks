        ...
        statics: {
            methods: {
                ...
                validateReflectable: function (type) {
                    do {
                        var ignoreMetaData = type === System.Object || type === Object || type.$literal || type.$kind === 17,
                ...
                SerializeObject: function (obj, formatting, settings, returnRaw, possibleType, dictKey) {
                    ...
                    if (possibleType && objType) {
                        if (possibleType.$kind === 3 || Bridge.Reflection.isAssignableFrom(possibleType, objType)) {
                            possibleType = null;
                        }
                    }
                ...
                getInstanceBuilder: function (type, raw, settings) {
                    ...
                    if (isEnumerable || isObject) {
                        ...
                        if (!hasDefault && !jsonCtor && type.$kind === 4) {
                            var useDefault = true;
